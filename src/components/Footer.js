          ...
          <div className="row">
            <div className="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
              <ul className="list-inline text-center footer-links">
                ...
                <li>
                  <a href="https://linkedin.com/in/rené-fernández-sánchez-73870226" title="LinkedIn">
                            <span className="fa-stack fa-lg">
                <i className="fa fa-circle fa-stack-2x"></i>
              ...
              <p className="copyright text-muted">
                René Fernández Sánchez &nbsp;&bull;&nbsp; {this.getCurrentYear()} &nbsp;&bull;&nbsp;
              ...
              <div className="theme-by text-muted">
                {"Change Language: "}
                {(this.getLanguage() === "es" || this.getLanguage() === "es-ES") ?
                  <button type="button" className="btn btn-primary" onClick={() => this.changeLanguage("en")}>en</button>
                  :
                  <button type="button" className="btn btn-primary" onClick={() => this.changeLanguage("es")}>es</button>
                }
              </div>
            </div>
          </div>
